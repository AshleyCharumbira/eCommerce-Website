...
.service-box{
    ...
    border: 2px solid rgb(138, 216, 138);
    border-radius: 20px;
    display: flex;
    justify-content: center;
    align-items: center;
...
<div class="service-box"  >
    ...
    <form action="https://formspree.io/f/xyyrqqwz" method="POST">
            <h1 style="color: #355E3B; font-size:30px;">Quote Request</h1>
            ...
            <div>
                <div class="text-center">
                    <button type="submit"  class="q-button" stye="  padding: 10px 20px;">Request Quote</button>
                </div>
            </div>
