...
<div class="service-box"  >
    ...
    <form action="https://formspree.io/f/mayrgger" method="POST">
            <h1 style="color:white; font-size:30px;">Request Service</h1>
            ...
            <div>
                <div class="text-center">
                    <button type="submit" name="sign_up" value="sign_up" class="q-button" stye="  padding: 10px 20px;">Request Service</button>
                </div>
            </div>
