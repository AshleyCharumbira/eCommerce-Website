	...
	<?php
				...
				<button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
				  ...
				  <ul class="sidebar">
					...
					<form class="d-flex" role="search" action="search_certificate.php" methof="get">
					<input class="form-control me-2" type="search" placeholder="Search Cetificates" aria-label="Search" name="search_data">
					<input type="submit" class="btn btn-outline-success" value="Search" name="search_data_certificate">
					</form>
				  </div>
				</div>
			  </nav>
			  ...
			  <nav class="navbar navbar-expand-lg navbar-dark bg-success bg-gradient text-white" style="height:20%">
				...
				<?php
					if(isset($_SESSION['username'])){
						...
						<a class='nav-link' style='font-size:20px; color: whitel'>Welcome, ".$_SESSION['username'].".</a>
						</li>
						<li class='nav-item'>
		...
		<div class="row">
			...
			<div>
			<br>
			<h3 class="text-center" style="color:#6d9f33">Certificates</h3>
			<p class="text-center" style="color: white; font-size:15px;">Book an inspection and get your certification today!</p>
		</div>
