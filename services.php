...
<body >
	...
	<?php
				...
				<button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
				  ...
				  <ul class="sidebar">
					...
					<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					  ...
					  <li class="hideOnMobile">
						<a class="nav-link active" style="font-size:20px;" href="services.php"><i class="fa-solid fa-broom" style="color: #FFD43B;"></i>Services</a>
					  </li>
					  <li class="hideOnMobile">
						<a class="nav-link"  style="font-size:20px;" href="products.php"><i class="fa-solid fa-spray-can-sparkles" style="color: #FFD43B;"></i> Products</a>
					  </li>
					...
					<form class="d-flex" role="search" action="search_service.php" methof="get">
						<input class="form-control me-2" type="search" placeholder="Search Services" aria-label="Search" name="search_data">
						<input type="submit" class="btn btn-outline-success" value="Search" name="search_data_service">
					</form>
				  </div>
				</div>
			  </nav>
	 ...
	 <!--Services offered - content loaded from database-->
	 ...
	 <div class="row ">
			...
			<!--services offered-->
				...
				<li class="nav-item" style="background-color: #000000">...</li>
		...
		<div>
			<br>
			<h3 class="text-center" style="color:#6d9f33 ">Services</h3>
			<p class="text-center" style="color: white">Browse our commercial and residential pest control services</p>
		</div>
				<div class="row">
