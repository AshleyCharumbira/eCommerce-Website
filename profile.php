        ...
        <div class="row">
             <div class="col-md-2 p-0">
                <ul class="navbar-nav bg-secondary">
                     <li class='nav-item bg-success'  style="font-size: 20px; color: white; text-align: center; padding: 10px 0;">Options</li>  
                    <li  style="font-size: 18px; color: white; text-align: center; padding: 10px 0;"><a href='profile.php?my_order' class='nav-link text-light'>View Orders</a></li>
